...
import CountdownTimer from "@/app/demo-3/components/CountdownTimer";
import TextCursorProximity from "@/app/demo-3/components/TextCursorProximity";
      ...
      >
        ...
        >
          {/* <div className="pt-10 pb-6 px-6 sm:p-16 text-center bg-dark/20">
            ...
            <p className="sm:text-2xl mb-6 sm:mb-8 leading-snug max-w-[450px] mx-auto text-balance tracking-wide">Join our newsletter to be the first to know when Panvera launches.</p>
